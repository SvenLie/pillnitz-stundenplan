              ...
              <Switch>
                  ...
                  <Route path="/datenschutz">
                      <div className="App-content">
                          ...
                          <h6>Hinweis zur verantwortlichen Stelle</h6> <p>Die verantwortliche Stelle für die Datenverarbeitung auf dieser Website ist:</p> <p>Sven Liebert<br />
                          Gasteiner Str. 11<br />
                          01279 Dresden</p>
                          ...
                          <h6>Allgemeine Hinweise zu den Rechtsgrundlagen der Datenverarbeitung auf dieser Website</h6> <p>Sofern Sie in die Datenverarbeitung eingewilligt haben, verarbeiten wir Ihre personenbezogenen Daten auf Grundlage von Art. 6 Abs. 1 lit. a DSGVO bzw. Art. 9 Abs. 2 lit. a DSGVO, sofern besondere Datenkategorien nach Art. 9 Abs. 1 DSGVO verarbeitet werden. Sofern Sie in die Speicherung von Cookies oder in den Zugriff auf Informationen in Ihr Endgerät (z. B. via Device-Fingerprinting) eingewilligt haben, erfolgt die Datenverarbeitung zusätzlich auf Grundlage von  § 25 Abs. 1 TTDSG. Die Einwilligung ist jederzeit widerrufbar. Sind Ihre Daten zur Vertragserfüllung oder zur Durchführung vorvertraglicher Maßnahmen erforderlich, verarbeiten wir Ihre Daten auf Grundlage des Art. 6 Abs. 1 lit. b DSGVO. Des Weiteren verarbeiten wir Ihre Daten, sofern diese zur Erfüllung einer rechtlichen Verpflichtung erforderlich sind auf Grundlage von Art. 6 Abs. 1 lit. c DSGVO. Die Datenverarbeitung kann ferner auf Grundlage unseres berechtigten Interesses nach Art. 6 Abs. 1 lit. f DSGVO erfolgen. über die jeweils im Einzelfall einschlägigen Rechtsgrundlagen wird in den folgenden Absätzen dieser Datenschutzerklärung informiert.</p>
                      ...
                      <div className="App-content">
                          ...
                          <Form onSubmit={handleSubmit}>
                              <Form.Select id="course" required>
                                  ...
                                  {courses.map(course => <option key={course.id} value={course.id}>{course.description}</option>)}
                              </Form.Select>
                              <br />
                              <>
                                  <FloatingLabel
                          ...
                          <div className="result">
                              <p>Anleitung für:</p>
                              <ul>
                                  <li><a href="https://support.apple.com/de-de/guide/iphone/iph3d1110d4/ios" rel="noreferrer" target="_blank">iOS (Abschnitt "Kalender abonnieren" mit der URL oben)</a></li>
                                  <li><a href="https://support.google.com/calendar/answer/37100?hl=de&co=GENIE.Platform%3DDesktop&oco=1" rel="noreferrer" target="_blank">Android (Abschnitt "Öffentlichen Kalender über einen Link hinzufügen")</a></li>
                              </ul>
                          </div>
                          <p className="hidden">Link für das Kalenderasbonnement: <a href="https://api.sven-liebert.de" id="link">https://api.sven-liebert.de</a></p>
                      </div>
                  </Route>
                  <Route exact path="/">
